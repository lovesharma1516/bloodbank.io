	 ...
	 if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])){
	 	...
	 	if(isset($_POST['date'])){
	 		...
	 		$showForm = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Do you really want to update your donation record?</strong>
				...
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<span>You have saved 1 person, You will donate the blood again after 3 Months. Thanks For The Blood Donation!</span>
							</div>';
									}
