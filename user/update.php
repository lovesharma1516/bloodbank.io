	 ...
	 if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])){
		 ...
		 if(isset($_POST['submit'])){
			 ...
			 $dateError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
  											<strong>Please select a day input.</strong>
  											<button type="button" class="close" data-dismiss="alert" aria-label="Close">
   										 	<span aria-hidden="true">&times;</span>
  											</button>
  											</div>';
					...
					//input check of month
					if(isset($_POST['month']) && !empty($_POST['month'])){

  	  			$month = $_POST['month'];
		}else{
			 $monthError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
  											<strong>Please select a month input.</strong>
  											<button type="button" class="close" data-dismiss="alert" aria-label="Close">
    										<span aria-hidden="true">&times;</span>
  											</button>
  											</div>';
			 ...
			 $cityError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
  	  		 ...
  	  		 $contactError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
  												<strong>Contact Number should consist of 11 characters.</strong>
  												<button type="button" class="close" data-dismiss="alert" aria-label="Close">
   			 									<span aria-hidden="true">&times;</span>
  												</button>
  												</div>';
			 		...
			 		$contactError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
  												<strong>Please fill the contact feild.</strong>
  												<button type="button" class="close" data-dismiss="alert" aria-label="Close">
    											<span aria-hidden="true">&times;</span>
  												</button>
  												</div>';
  		...
  		$pattern = '/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$/';
  	  	...
  	  	if(preg_match($pattern, $_POST['email'])){
  	  		...
  	  		if(mysqli_num_rows($result)>0){
					...
					if(isset($name) && isset($blood_group) && isset($gender) && isset($date) && isset($month) && isset($year) && isset($email) && isset($contact) && isset($city)){
...
$sql = "SELECT * FROM donor WHERE id=".$_SESSION['user_id'];
		...
		if(mysqli_num_rows($result)>0){
			...
			while ($row = mysqli_fetch_assoc($result)) {
				...
				// [0] 2021-[1]-10-[2]-18 Using Saperator "-" we are Saperting String of DOB portion.//
						...
						if($oldpassword == $dbPassword){
							...
							if($_POST['new_password'] == $_POST['c_password']){
							 ...
							 $passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
  																	<strong>The password you re-entered is not matched!.</strong>
  																	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
    																<span aria-hidden="true">&times;</span>
  																	</button>
  																	</div>';
							...
							$passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
  																	<strong>The password should consist of 6 letters atleast!.</strong>
  																	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
    																<span aria-hidden="true">&times;</span>
  																	</button>
  																	</div>';
...
<style>
	...
	<option value="">-- Select --</option><?php if(isset($city)) echo '<option selected="" value="'.$city.'">'.$city.'</option>';  ?><optgroup title="Azad Jammu and Kashmir (Azad Kashmir)" label="&raquo; Azad Jammu and Kashmir (Azad Kashmir)"></optgroup><option value="kotli" >kotli</option><option value="Mirpur" >Mirpur</option><option value="Muzaffarabad"> Muzaffarabad </option><option value=" Neelum" > Neelum</option><option value="Poonch" > Poonch </option><optgroup title="Balochistan" label="&raquo; Balochistan"></optgroup><option value="Barkhan" >Barkhan</option><option value="Gwader" >Gwader</option><option value="Naseerabad" >Naseerabad</option><option value="Quetta" >	Quetta</option><option value="Sibi" > Sibi</option><optgroup title="Islamabad Capital" label="&raquo; Islamabad Capital"></optgroup><option value="Islamabad" >Islamabad</option><optgroup title="(KPK)" label="&raquo; (KPK)"></optgroup><option value="Karak" >Karak</option><option value="Manshera" >Manshera</option><option value="Peshawar" > Peshawer</option><option value="Shangla" > Shangla</option><option value="Swat" > Swat</option><optgroup title="Punjab" label="&raquo; Punjab"></optgroup><option value="Bahawalpur" >Bahawalpur</option><option value="Gujranwala" >Gujranwala</option><option value="Lahore" >Lahore</option><option value="Rawalpindi" >Rawalpindi</option><option value="Sialkot" >Sialkot</option><optgroup title="Sindh" label="&raquo; Sindh"></optgroup><option value="Karachi" >Karachi</option><option value="Hyderabad" >Hyderabad</option><option value="Nawabshah" >Nawabshah</option><option value="Badin" >Badin</option><option value="Ghotki" >Ghotki</option></select>
